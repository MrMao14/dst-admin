...
async function lets_go() {
    ...
    window.alert(link_suf.toString());
...
async function get_world_json() {
    // const url = 'https://dst.suke.fun/misc/dst_world_setting.json';
...
function search_event() {
    ...
    function search_mod(text) {
        ...
        let url = 'https://dst.suke.fun/tools/searchmod';
...
async function add_mod_to_world(modid, nocheck=false) {
    ...
    if (mod_info_saved[modid]) {
        ...
        const url = `https://dst.suke.fun/tools/mod/${modid}`;
